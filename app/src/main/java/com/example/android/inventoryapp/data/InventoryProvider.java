...
public class InventoryProvider extends ContentProvider {
    ...
    private Uri insertProduct(Uri uri, ContentValues contentValues) {
        ...
        Integer count = contentValues.getAsInteger(InventoryEntry.COLUMN_PRODUCT_COUNT);
        ...
        Double price = contentValues.getAsDouble(InventoryEntry.COLUMN_PRODUCT_PRICE);
    ...
    private int updateProduct(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        // Check that the count is non-negative
        if (values.containsKey(InventoryEntry.COLUMN_PRODUCT_COUNT)) {
            Integer count = values.getAsInteger(InventoryEntry.COLUMN_PRODUCT_COUNT);
            if (count == null || count < 0) {
                throw new IllegalArgumentException("Product requires a count greater than or equal to 0");
            }
        }
        ...
        int numRowsUpdated =  db.update(InventoryEntry.TABLE_NAME, values, selection, selectionArgs);
