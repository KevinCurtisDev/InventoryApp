...
/**
 * Created by kevincurtis on 27/07/2017.
 */

public class InventoryDetail extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        if(cursor.moveToFirst()) {
            ...
            int countColumnIndex = cursor.getColumnIndex(InventoryEntry.COLUMN_PRODUCT_COUNT);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                NavUtils.navigateUpFromSameTask(InventoryDetail.this);
                return true;
        }
